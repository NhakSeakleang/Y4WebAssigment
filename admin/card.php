<?php
    include("Desktop/EcommerceWebsite/admin/include/header.inc");
    include("Desktop/EcommerceWebsite/admin/include/sidebar.inc");
    include("Desktop/EcommerceWebsite/admin/include/footer.inc");
?>
