...
?>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="fc-left">
                        <h3 style="padding:10px 0px;">Products Page</h3>
                    </div>
                    <a style="float:right;" href="add_product.php" ><button class="au-btn au-btn--blue m-b-20" name="addProduct" type="submit">Add Product</button></a>
